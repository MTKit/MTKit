...
typedef NS_ENUM(NSUInteger, TZImagePickerType) {
    TZImagePickerTypeChat = 0,
    TZImagePickerTypeCircle = 1,
};
...
@property (nonatomic, assign, readonly) TZImagePickerType type;
...
/** 记录不同文件夹的选中, 默认是False */
@property (nonatomic, assign) BOOL remeberSelectedModes;
...
@property (nonatomic, assign) BOOL showSelectBtn;   ///< 在单选模式下，照片列表页中，显示选择按钮,默认为YES
